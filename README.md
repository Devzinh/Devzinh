...
const devzinh = {
    ...
    interesses: ["Clean Code", "Arquitetura de Software"],
    
    aprendendo: ["C", "C++", "Golang", "Python", "C#", "Java", "PHP", "JavaScript", "TypeScript "],
    
    hobbies: ["Programar", "Games", "Música"],
    
    mensagem: "Não se preocupe se não funcionar direito. Se tudo funcionasse, você estaria desempregado."
};
```
